...
It owns `plugin.proto`, generated Go protobuf types, 4-byte big-endian framed
...
The normative wire rules are initially documented in
`liapoldus.github.io/public/spec/plugin.proto` and Gateway architecture docs.
Any disagreement is blocked pending an explicit decision.
